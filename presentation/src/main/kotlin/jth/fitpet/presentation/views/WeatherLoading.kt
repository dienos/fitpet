...
import jth.fitpet.presentation.databinding.WeatherProgressBarBinding

class WeatherLoading(context: Context) {
    private var binding : WeatherProgressBarBinding ?= null
    ...
    init {
        binding = WeatherProgressBarBinding.inflate((context as Activity).layoutInflater)
